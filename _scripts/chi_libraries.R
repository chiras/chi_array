...
cat("Checking for/Installing missing packages\n")
source("http://bioconductor.org/biocLite.R")

if (sum(installed.packages()[,1]=="DBI")==0) {biocLite("DBI")}
...
if (sum(installed.packages()[,1]=="DBI")==0) {install.packages("DBI", dependencies = TRUE)}
if (sum(installed.packages()[,1]=="RSQLite")==0) {install.packages("RSQLite", dependencies = TRUE)}
if (sum(installed.packages()[,1]=="xtable")==0) {install.packages("xtable", dependencies = TRUE)}
if (sum(installed.packages()[,1]=="XML")==0) {install.packages("XML", dependencies = TRUE)}
...
if (sum(installed.packages()[,1]=="made4")==0) {install.packages("made4", dependencies = TRUE)}
